...
- [x] **4.1 — IAM roles, trust policies, STS AssumeRole** — [notes](scs-c03-lab-4_1-iam-roles-sts.md). Proves the trust policy is the gatekeeper by breaking same-account assume three ways.
